...
function Scenario(props) {
    ...
    let choice1 = "Attack with " + user.characters[0].weapon
    let choice2 = "Hide"
    let Scenario = ""

    if(choices === "Begin") {
        Scenario = "Hello " + user.characters[0].characterName + ", you are a" + user.characters[0].class + "and your level is " + user.characters[0].level + ". As you are walking down a road that has a mysterious amount of pineapple growing from th ground... Suddenly, you see a massive 2 story tall pineapple. What do you do? "
    }


    else if(choices === "Attack with " + user.characters[0].weapon) {
        if(user.characters[0].weapon === "Axe") {
        ...
        choice1 = "Next choice 1"
            ...
            Scenario = "You run at it with your " + user.characters[0].weapon+ " like a maniac. Startled by this tiny mammals random courage, it performs a massive jump away from you. You rethink your life choices as you hear a massive CRASH in the distand woods."
        }
    }
        ...
        if(user.characters[0].weapon === "Axe" && choices === "Surprise attack it") {
